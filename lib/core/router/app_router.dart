...
import '../../presentation/pages/copilot_page.dart';
...
class _SplashScreenState extends ConsumerState<_SplashScreen> {
  ...
  void initState() {
    super.initState();
    // 15 秒超时兜底——iOS 首次冷启 / Flutter engine 慢 → 强制进 login
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('个人知识管理平台', style: theme.textTheme.titleMedium?.copyWith(color: theme.hintColor)),
            const SizedBox(height: 8),
            Text('首次启动可能需要 10-15 秒…', style: theme.textTheme.bodySmall?.copyWith(color: theme.hintColor)),
          ],
        ),
      ),
    );
