...
class Item {
  ...
  final Map<String, dynamic>? summarySections;
  ...
  factory Item.fromJson(Map<String, dynamic> j) => Item(
        ...
        summarySections: j['summary_sections'] is Map ? Map<String, dynamic>.from(j['summary_sections']) : null,
        summaryLong: j['summary_long'] as String?,
