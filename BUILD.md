...
> 本工程同时输出 iOS / Android。已验证：macOS 26.5 + Xcode 26.6 + Flutter 3.44.4 + JDK 17 环境下双端可本地构建。
...
├── android/                   # Android 工程（AGP 8.7 / Gradle 8.9 / minSdk 21）
├── ios/                       # iOS 工程（Podfile 就绪，部署目标 iOS 13）
├── .github/workflows/
...
- `https://jarkko-cloud-2-d6gfsv71afe0890fc.service.tcloudbase.com/items-api`
...
**Q：登录提示"网络异常"**
A：检查云函数 HTTP 网关已开（已在 deploy 时通过 MCP 自动开通）。在浏览器访问 `https://jarkko-cloud-2-d6gfsv71afe0890fc.service.tcloudbase.com/user-api` 应返回 4xx 而非 404。
